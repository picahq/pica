...
//         const script = oauthDef.compute.init.computation;
//         let computationResult: Record<string, unknown> | undefined;
//         if (script) {
//             computationResult = (await compute(serializedPayload, script)) as
//               | Record<string, unknown>
//               | undefined;
//         }
//
//         const queryResult = await query(oauthDef, computationResult);
//         console.log(queryResult); // e.g., { client_id: "client123", scope: "read" }
//
//         const bodyResult = await body(serializedPayload, computationResult);
//         console.log(bodyResult); // e.g., { token: "data" }
//     } catch (error) {
//         console.error(error);
//     }
// }
//
// async function testOAuthRequest() {
//     try {
//         const oauthResponse = await executeOAuthRequest(oauthDef, payload);
//         console.log('OAuth Response:', oauthResponse);
//         // e.g., { access_token: "data", expires_in: 3600, refresh_token: undefined, token_type: "Bearer" }
//     } catch (error) {
//         console.error(error);
//     }
// }

// const oauthDef: ConnectionOAuthDefinition = {
//     _id: '123',
//     configuration: {
//         init: {
...
//         },
//         refresh: { baseUrl: '', path: '' },
//     },
//     connectionPlatform: 'example',
//     compute: {
//         init: {
//             computation: {
//                 entry: 'processData',
//                 function:
//                   'const processData = async (payload) => { return { queryParams: { client_id: payload.client_id }, body: { token: payload.metadata.extra } }; }',
//             },
//             response: {
//                 entry: 'decodeResponse',
//                 function:
//                   'const decodeResponse = async (response) => { return { access_token: response.token, expires_in: 3600, refresh_token: response.refresh || undefined, token_type: "Bearer" }; }',
//             },
//         },
//         refresh: { response: { entry: '', function: '' } },
//     },
// };
//
